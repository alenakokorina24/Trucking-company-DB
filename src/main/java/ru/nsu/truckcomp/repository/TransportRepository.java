...
public interface TransportRepository extends TransportBaseRepository<Transport> {
    ...
    @Query(value = "SELECT new ru.nsu.truckcomp.model.TransportArea(t.id, t.brand, t.state, t.garage, g.area) FROM Transport t INNER JOIN Garage g ON t.garage.garageId=g.garageId")
